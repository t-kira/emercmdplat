...
public class MedicalInstitution extends BaseObject {
	 ...
	 * 机构等级
	 */
	@ApiComment(value = "机构等级", sample = "1")
	@NotNull(message = "机构等级不能为空")
	@DecimalMin(value = "1", message = "机构等级必须大于0")
	@DecimalMax(value = "10", message = "机构等级必须小于10")
	 ...
	 * 病床数
	 */
	@ApiComment(value = "病床数", sample = "1")
	@NotNull(message = "病床数不能为空")
	@DecimalMin(value = "1", message = "病床数必须大于0")
	private Integer sickbedNum;
	/**
	 * 诊疗科目
	 */
	@ApiComment(value = "诊疗科目", sample = "aaa")
	@NotNull(message = "诊疗科目不能为空")
