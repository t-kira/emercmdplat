...
public class HttpUtils {
    ...
    public static void main(String[] args) throws Exception{
        String nonce = "1234543";
        String appSecret = WebSecurityConfig.APP_SECRE;
        String timestamp = StringUtil.toStr(DateUtil.getNowDate().getTime());
        String signature = SecuritySHA1Utils.shaEncode(appSecret + nonce + timestamp);
        ...
        params.put("userId", "jjl3fsd");
        params.put("name", "kira");
        params.put("portraitUri", "http%3A%2F%2Fabc.com%2Fmyportrait.jpg");
        String str = post(WebSecurityConfig.RONGCLOUD_API_URL, params, headers, WebSecurityConfig.HTTP_CONNECT_TIMEOUT, WebSecurityConfig.HTTP_READ_TIMEOUT, "UTF-8");
