...
public class EmergencySupplyController extends BaseController {
    ...
    public String insert(@ApiComment(value="添加应急物资",sample="根据id查询物资接口可查看字段信息") @RequestBody EmergencySupply emergencySupply) {
    ...
    public String update(@ApiComment(value="修改应急物资",sample="根据id查询物资接口可查看字段信息") @RequestBody EmergencySupply emergencySupply) {
